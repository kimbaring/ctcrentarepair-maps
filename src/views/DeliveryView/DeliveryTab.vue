  ...
  <ion-page>
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom">
        <ion-tab-button tab="tdashboard" href="/delivery/dashboard">
          <ion-icon :icon="homeOutline" />
        </ion-tab-button>
        <ion-tab-button tab="tasks" href="/delivery/tasks">
          <ion-icon :icon="buildOutline" />
        </ion-tab-button>
        <ion-tab-button tab="ttransactionhistory" href="/delivery/transactionhistory">
          <span class="notif" v-if="counter > 0">1</span>
          <ion-icon :icon="timeOutline" />
        </ion-tab-button>
        <ion-tab-button tab="notif" href="/delivery/notification">
          <ion-icon :icon="notificationsOutline"></ion-icon>
        </ion-tab-button>
        <ion-tab-button tab="tprofile" href="/delivery/profile">
