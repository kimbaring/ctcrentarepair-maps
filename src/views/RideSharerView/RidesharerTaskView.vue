...
<ion-page>
    <ion-content>
        <div class="section">
            <h3>Available Ride Sharer Tasks</h3>
            <img src="../../img/car.png">
        </div>
    ...
    mounted(){
        ...
        onValue(que,()=>{
            get(que).then(snapshot=>{
                this.availableTasks=[];
                if(snapshot.exists()) for(let t in snapshot.val()) if(snapshot.val()[t].service_type == 'Ride Sharer') this.availableTasks.push(snapshot.val()[t]);
