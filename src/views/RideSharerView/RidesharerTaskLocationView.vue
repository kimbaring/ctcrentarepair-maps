        ...
        <ion-content v-if="$route.path == '/ridesharer/tasks/taskdetails/location'">
            ...
            <div class="task_info">
                ...
                <div class="col2 breakdown">
                    ...
                    <span v-if="feeComputation[4] > 0">Priority Fee</span>
                    <span v-if="feeComputation[4] > 0">${{feeComputation[4]}}</span>
                    <span>VAT</span>
    ...
    methods: {
        ...
        fetchDistance(){
            ...
            axiosReq({   
                ...
                const baseFee = parseFloat(configs[`fee_ridesharer_base_charge`]);
                const appChargeRate = parseFloat(configs[`fee_ridesharer_app_charge`]);
                const vat = parseFloat(configs.fee_vat_charge);
                const d = parseFloat(configs[`fee_ridesharer_dist_charge`])
