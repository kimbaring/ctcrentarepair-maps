<template>
    <ion-page>
        <ion-content>
            <div class="content">
                <h3>Trip has started!</h3>
                <img src="@/img/traveling.svg">
                <p>Press ‘Finish Trip’ after receiving the payment, so you can finish this task and accept new ones.</p>
                <div class="col2">
                    <span>Customer</span>
                    <span>{{customer}}</span>
                ...
                <ion-button expand="block" @click="finishTrip">Finish Trip</ion-button>
            </div>
        </ion-content>
    </ion-page>
</template>
...
export default ({
    ...
    mounted(){
        local.set('task_linear_path','/ridesharer/trip');
    ...
    methods:{
        finishTrip(){
            ...
            setTimeout(()=>this.$router.replace('/ridesharer/finished'),1000);
        }
    }
})
</script>   
