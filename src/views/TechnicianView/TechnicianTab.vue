  ...
  <ion-page>
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom">
        <ion-tab-button tab="tdashboard" href="/technician/dashboard">
          <ion-icon :icon="homeOutline" />
        </ion-tab-button>
        <ion-tab-button tab="tasks" href="/technician/tasks">
          <ion-icon :icon="buildOutline" />
        </ion-tab-button>
        <ion-tab-button tab="ttransactionhistory" href="/technician/transactionhistory">
          <span class="notif" v-if="counter > 0">1</span>
          <ion-icon :icon="timeOutline" />
        </ion-tab-button>
        <ion-tab-button tab="notif" href="/technician/notification">
