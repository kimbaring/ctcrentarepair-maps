    ...
    <ion-page>
        ...
        <ion-content>
            ...
            <div class="submit_btn">
                <ion-button expand="block" @click="submits">Submit</ion-button>
            </div>
        </ion-content>
    </ion-page>
</template>
...
import {local, openToast,validateForm, axiosReq, dateFormat, optimizeImage, lStore,removeFix} from '@/functions';
            ...
            getDownloadURL(sref(storage,'car-images/'+generateFileName)).then(dlink=>{
                ...
                axiosReq({
                    ...
                    if(res.data.success){
                        ...
                        updatedList = [...lStore.get('cars')];
                        updatedList.push(removeFix(res.data.car_info,'car_'));
